...
var bullet =load("res://assets/player/bullet.tscn")
var instance
var flight_time = 1
...
@export var FRICTION: float = 9 # Higher friction = less slippery. In quake-based games, usually between 1 and 5
